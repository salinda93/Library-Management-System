...
<?php if($result->ReturnDate=="")
    ...
    $date1=$result->IssuesDate;
    $date2=date("Y-m-d H:i:s");

    $diff = abs(strtotime($date2) - strtotime($date1));

    $days = floor($diff / (60*60*24));
    $book_fine = ($days-14)*10 . " LKR";
    ...
    <!-- End of Calculating the fine -->
<div class="form-group">
<label>Fine (in USD) :</label>
<?php 
if($result->fine=="")
{?>
<input class="form-control" type="text" name="fine" id="fine" value=<?php echo($book_fine);?> required />
